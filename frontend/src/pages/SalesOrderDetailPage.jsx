...
if (loading) {
return <p className="text-sm text-gray-500">Loading sales order...</p>;
}
if (error && !order) {
return (
...
Review order details and confirm if stock is available.
</p>
</div>
{isDraft ? (
...
{successMessage ? (
<div className="rounded-lg border border-green-200 bg-green-50 p-4 textsm text-green-700">
{successMessage}
</div>
) : null}
...
<div>
<dt className="text-gray-500">Order No</dt>
